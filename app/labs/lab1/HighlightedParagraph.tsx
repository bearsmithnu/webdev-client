...
export default function HighlightedParagraphLab() {
  return (
    <div id="wd-highlighted-paragraph">
      ...
      <HighlightedParagraph
      text="I'm from a small town in New Hampshire not close enough to any notable
      landmarks to give reference, but if you're a local or a hiker you may know Mount Monadnock.
